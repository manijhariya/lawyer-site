	...
	<div className = "about-section">
            <div className = "about-text-section">
                ...
                <p className = "about-section-text">With more than a dozen attorneys and 
                    ...
                    higher settlements, and happier clients. <br/>
...
function DetailAbout() {
	...
	<div className="about-container" align="left">
	 ...
	 <h1>Vipul Saraswat </h1>
         <h3>(91) 9806747363 | saraswat.vipul@gmail.com </h3>
...
Prior to founding Law Firm, Vipul was a partner at different firms, a global law firm, the world’s largest employment and labor practice.  He graduated from National Law Institute University Bhopal, LLB in 2006. 
 </p>
	 </div>
	 <div className="about-cotainer-section-2">
	 <img className="profilephoto" src={ProfilePhoto} alt="ProfilePhoto"></img>
	 <h4 className="eduction-headers"> Education
	 <p className="educationContent"> National Law Institute University <br/>
					  Bhopal, LLB, 2006 </p> </h4> <h4 className="eduction-headers"> Court Admission <br /> <p 
	className="educationContent"> Civil Court Jabalpur 2010 <br /> High Court Jabalpur 2010 </p> </h4>
	 </div>
	</div>
	</div>
)
